...
public class Form2Bean {
	...
	public static  Comment commentForm2Bean(HttpServletRequest request) throws FailException{
		...
		if(vilidate(bean)){
			...
			System.out.println("Form2Bean -> commentForm2Bean success / " + bean.getTime());
			return bean;
	...
	public static Article articleForm2Bean(HttpServletRequest request) throws FailException{
		...
		value.put("datetime",request.getParameter("time"));
		value.put("author",request.getParameter("author"));
		value.put("blog_sort", request.getParameter("sort"));		
		//String tags = request.getParameter("tags");		
		value.put("blog_content", request.getParameter("content"));		
		value.put("blog_star", 0);
		value.put("blog_comment", 0);
		value.put("visit",0);
